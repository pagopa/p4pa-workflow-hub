...
class DebtPositionCustomWfSyncServiceTest {
  ...
  void whenInvokeWorkflowThenDoNothingAndReturnNull(){
    Assertions.assertNull(service.invokeWorkflow(new DebtPositionDTO(), new PaymentEventRequestDTO(PaymentEventType.DP_CREATED, "EVENTDESCRIPTION"), new WfExecutionParameters(false, false, Mockito.mock(WfExecutionConfig.class))));
  }
}
