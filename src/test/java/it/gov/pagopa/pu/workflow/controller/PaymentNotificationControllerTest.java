...
@WebMvcTest(PaymentNotificationControllerImpl.class)
...
class PaymentNotificationControllerTest {
  ...
  @Test
  void whenCreatePaymentNotificationsProcessThenOk() throws Exception {
    ...
    Mockito.when(paymentNotificationIngestionWFClientMock.ingest(ingestionFlowFileId))
    ...
    try (MockedStatic<SecurityUtils> securityUtilsMockedStatic = Mockito.mockStatic(SecurityUtils.class)) {
      ...
      MvcResult result = mockMvc.perform(
          post("/workflowhub/workflow/payment-notification/{ingestionFlowFileId}", ingestionFlowFileId))
