...
public class ClassifyAssessmentsWfConfig extends BaseWfConfig {
  ...
  public NotifyPaymentAssessmentsActivity buildNotifyPaymentAssessmentsActivityStub() {
    return Workflow.newActivityStub(NotifyPaymentAssessmentsActivity.class, TemporalWFImplementationCustomizer.baseWfConfig2ActivityOptions(
