...
public interface SynchronizeSyncGpdPreLoadWF {
  @WorkflowMethod
  SyncStatusUpdateRequestDTO synchronizeDPSyncGpdPreLoad(DebtPositionDTO debtPosition, PaymentEventRequestDTO paymentEventRequest, GenericWfExecutionConfig wfExecutionConfig);
}
