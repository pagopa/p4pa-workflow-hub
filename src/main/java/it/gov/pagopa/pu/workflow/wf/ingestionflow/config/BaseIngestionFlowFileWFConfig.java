package it.gov.pagopa.pu.workflow.wf.ingestionflow.config;
...
@Configuration
@ConfigurationProperties(prefix = "workflow.base-ingestion-flow")
public class BaseIngestionFlowFileWFConfig extends BaseWfConfig {
