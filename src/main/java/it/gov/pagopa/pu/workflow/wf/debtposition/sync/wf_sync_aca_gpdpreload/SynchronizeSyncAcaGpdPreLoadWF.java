...
public interface SynchronizeSyncAcaGpdPreLoadWF {
  @WorkflowMethod
  SyncStatusUpdateRequestDTO synchronizeDPSyncAcaGpdPreLoad(DebtPositionDTO debtPosition, PaymentEventRequestDTO paymentEventRequest, GenericWfExecutionConfig wfExecutionConfig);
}
