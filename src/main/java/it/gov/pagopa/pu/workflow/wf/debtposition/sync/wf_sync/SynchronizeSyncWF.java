...
public interface SynchronizeSyncWF {
  @WorkflowMethod
  SyncStatusUpdateRequestDTO synchronizeDPSync(DebtPositionDTO debtPosition, PaymentEventRequestDTO paymentEventRequest, GenericWfExecutionConfig wfExecutionConfig);
}
