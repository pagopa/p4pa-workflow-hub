...
public class SynchronizeSyncWFImpl extends BaseDPSynchronizeWf implements SynchronizeSyncWF {
  ...
  @Override
  public SyncStatusUpdateRequestDTO synchronizeDPSync(DebtPositionDTO debtPosition, PaymentEventRequestDTO paymentEventRequest, GenericWfExecutionConfig wfExecutionConfig) {
