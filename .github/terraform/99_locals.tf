locals {
  ...
  common_tags = {
    ...
    Source      = "https://github.com/pagopa/p4pa-workflow-hub" # Repository URL
  ...
  github = {
    org        = "pagopa"
    repository = "p4pa-workflow-hub" # Repository Name
  }
  ...
  repo_env = var.env_short == "p" ? {
    SONARCLOUD_PROJECT_NAME = "p4pa-workflow-hub"
    SONARCLOUD_PROJECT_KEY  = "pagopa_p4pa-workflow-hub"
