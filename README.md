...
| WORKFLOW_HUB_DB_CONNECTION_IDLE_TIMEOUT_MILLISECONDS   | PostgreSQL connection idle timeout (milliseconds)                             | 600000                                                                                                                       |
| WORKFLOW_HUB_DB_CONNECTION_TIMEOUT_MILLISECONDS        | PostgreSQL connection timeout (milliseconds)                                  | 30000                                                                                                                        |
| WORKFLOW_HUB_DB_CONNECTION_KEEPALIVE_TIME_MILLISECONDS | PostgreSQL connection keepalive time (milliseconds)                           | 120000                                                                                                                       |
| WORKFLOW_HUB_DB_CONNECTION_MAX_LIFETIME_MILLISECONDS   | PostgreSQL connection max lifetime (milliseconds)                             | 1800000                                                                                                                      |
| WORKFLOW_HUB_DB_CONNECTION_MAX_POOL_SIZE               | PostgreSQL connection max pool size                                           | 10                                                                                                                           |
| WORKFLOW_HUB_DB_CONNECTION_MIN_IDLE                    | PostgreSQL connection min idle                                                | 10                                                                                                                           |
...
| KAFKA_TOPIC_REGISTRIES                                | Topic where to publish data events                | p4pa-payhub-data-events-evh | 
